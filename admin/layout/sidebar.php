...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="penjualan.php" class="menu-link">Penjualan</a>
                </li>
                <li class="menu-item">
                    <a href="produksi.php" class="menu-link">Produksi</a>
                </li>
                <li class="menu-item">
                    <a href="packing.php" class="menu-link">Packing</a>
                </li>
                <li class="menu-item">
                    <a href="pengiriman.php" class="menu-link">Pengiriman</a>
                </li>
            </ul>
        </li>
        <!-- BERANDA -->

// Koreksi penggunaan tanda kutip pada file history.php
// Menggunakan tanda kutip ganda (") untuk string dan tanda kutip tunggal (') untuk nilai array
// Memperbaiki kesalahan tanda kutip pada variabel dalam string

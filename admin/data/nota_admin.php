...
$time = date("H");
$selamat = "Pagi";
if ($time >= 12 && $time < 15) { $selamat = "Siang"; } else
if ($time >= 15 && $time < 19) { $selamat = "Sore"; } else
if ($time >= 19) { $selamat = "Malam"; }
            ...
            <div class="d-flex align-items-end row">
                <div class="col-md-6 order-2 order-md-1">
                    <div class="card-body">
                        ...
                        <p class="mb-0">Kamu memiliki <span class="fw-semibold"><?php echo $sales_hari_ini;?> Nota

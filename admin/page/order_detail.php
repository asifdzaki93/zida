                ...
                <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            if ($editing) {
                            ?>
                                <input class="form-control" type="text" id=from-datepicker value="<?php echo $order["due_date"]; ?>">
                            <?php
                            } else {
                            ?>
                ...
                <table class="table m-0">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td class="text-nowrap" width=2>
                                    ...
                                    if ($editing) {
                                    ?>
                                        <button onclick="hapusProduk('<?php echo $product["id_sales"]; ?>')" class="btn btn-icon btn-danger">
                                ...
                                <td class="text-nowrap">
                                    ...
                                    if ($editing) {
                                    ?>
                                        <input type=hidden id="product_<?php echo $product["id_sales"]; ?>_price" value="<?php echo $product["price"]; ?>">
                                        <input type=number onchange="hitungHarga('<?php echo $product["id_sales"]; ?>')" class="form-control product_amount" name="product_<?php echo $product["id_sales"]; ?>_amount" id="product_<?php echo $product["id_sales"]; ?>_amount" value="<?php echo $product["amount"]; ?>">
                                    <?php
                                    } else {
                                    ?>
                                ...
                                <td class="text-nowrap">
                                    <input type=hidden class="product_totalprice" id="product_<?php echo $product["id_sales"]; ?>_totalprice" value="<?php echo $product["totalprice"]; ?>">
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        <input id="childproduct_<?php echo $cp["id_packagesproduct"]; ?>_perpaket" type=hidden value="<?php echo $cp["perpaket"]; ?>">
                                    </td>
                                    <td class="text-nowrap childproduct_<?php echo $product["id_sales"]; ?>_amount" id="childproduct_<?php echo $cp["id_packagesproduct"]; ?>_amount">
                                        <?php echo $cp["amount"]; ?>
                                    </td>
                        ...
                        if ($editing) {
                            ...
                            <tr>
                                <td colspan=2>
                                    <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#tambah_produk">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-5">
                                ...
                                <p id=totalsubtract class="fw-semibold mb-0 text-nowrap text-end <?php echo $status_tagihan == "Lunas" ? "" : "text-danger" ?>">
            ...
            <div class="col-xl-3 col-md-4 col-12 invoice-actions">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="btn btn-outline-secondary d-grid w-100 mb-3 waves-effect" target="_blank" href="cetak_invoice.php?no_invoice=<?php echo $_GET["no_invoice"] ?? '' ?>">
                            Cetak
                        </a>
                        <?php
                        if ($editing) {
                        ?>
                            <a href="javascript:;" onclick="selesaiEdit()" class="btn btn-outline-secondary d-grid w-100 mb-3 waves-effect">
                                Preview Invoice
                            </a>
                        <?php
                        } else {
                        ?>
                            <a href="javascript:;" onclick="mulaiEdit()" class="btn btn-outline-secondary d-grid w-100 mb-3 waves-effect">
                                Edit Invoice
                            </a>
                        <?php
                        }
    ...
    <div class="modal fade" id="hapus_produk" tabindex="-1" aria-labelledby="hapus_produk_label" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="hapusProdukKonfirmasi()" class="btn btn-primary" data-bs-dismiss="modal">Konfirmasi</button>
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Batal</button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="selesai_edit" tabindex="-1" aria-labelledby="selesai_edit_label" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="selesaiEditKonfirmasi()" class="btn btn-primary" data-bs-dismiss="modal">Konfirmasi</button>
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Edit Ulang</button>
                    <button type="button" onclick="selesaiEditBatal()" class="btn btn-danger" data-bs-dismiss="modal">Kembali Ke Preview</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="offcanvas-body flex-grow-1">
            ...
            <div>
                ...
                <div class="mb-3 d-flex flex-wrap">
                    <button type="button" class="btn btn-primary me-3 waves-effect waves-light" data-bs-dismiss="offcanvas" onclick="tambahPembayaran()">Tambah Pembayaran</button>

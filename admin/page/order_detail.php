                ...
                <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column">
                    <div class="mb-xl-0 pb-3">
                        <div class="d-flex svg-illustration align-items-center gap-2 mb-4">
                            <img src="<?php echo $base_url; ?>assets//img/branding/ZIEDA.png" width=50>
                            <span class="h4 mb-0 app-brand-text fw-bold">Zieda Bakery</span>
                        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-5">
                                ...
                                <p
                                    class="fw-semibold mb-0 text-end <?php echo $status_tagihan=="Lunas"?"":"text-danger"?>">

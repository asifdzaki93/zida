                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end flex-wrap gap-1">
                                    <h6 class="mb-0 me-2 text-primary"><strong><?= 'Rp.' . number_format($totalPreOrderP, 0, ',', '.') ?></strong></h6>
                                    <small class="">Piutang: <?= number_format($lunas1, 0, ',', '.'); ?>%</small><small class="text-danger"><?= '(Rp.' . number_format($selisih, 0, ',', '.') . ')' ?></small>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 text-end d-flex align-items-end justify-content-center">
                    ...
                    <div class="">
                        <div class="card">
                            <div class="card-header pb-0">
                                ...
                                <h4 class="mb-1"><?= 'Rp.' . number_format($totalTransM, 0, ',', '.') ?></h4>
                            </div>
                            <div class="card-body">
                                <div class="row mt-3">
                                    <div class="col-4">
